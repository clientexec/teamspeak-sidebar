...
class PluginTeamspeak3status extends DashboardPlugin
{
    ...
    var $name = "Teamspeak 3 Status";
    var $smallName = "Teamspeak";

    var $description = "This plugin adds a dashboard panel which lists the current status of all teamspeak 3 servers.  Data shown includes server uptime, number of servers, number of clients online and total number of clients allowed.";
    var $default = false;
